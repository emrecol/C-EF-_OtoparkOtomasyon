...
{
    public partial class FormKat3 : Form
    {
        public FormKat3()
        {
            InitializeComponent();
        ...
        private void FormKat3_FormClosing(object sender, FormClosingEventArgs e)
        {
            AnaForm anafrm = (AnaForm)this.MdiParent;
            anafrm.tsbtnKat3.Enabled = true;
        }

        private void FormKat3_Load(object sender, EventArgs e)
        {
        ...
        private void cbMusteri_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            var arac = otoparkdb.musteri.Where(x => x.mus_adsoyad == cbMusteri.Text).Select(x => x.mus_aracplaka).ToList();
            cbPlaka.DataSource = arac;
        }

        private void cbAbonelik_SelectedValueChanged_1(object sender, EventArgs e)
        {
            var absure = cbAbonelik.SelectedIndex;
            int abonesure = 0;
            if (absure == 0)
