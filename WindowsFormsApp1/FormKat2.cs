...
{
    public partial class FormKat2 : Form
    {
        public FormKat2()
        {
            InitializeComponent();
        ...
        private void FormKat2_FormClosing(object sender, FormClosingEventArgs e)
        {
            AnaForm anafrm = (AnaForm)this.MdiParent;
            anafrm.tsbtnKat2.Enabled = true;
        }

        private void FormKat2_Load(object sender, EventArgs e)
        {
